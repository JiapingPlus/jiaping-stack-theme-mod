...
**预警**：我是一个史同女！如果你雷我CP（下面图片上的那两位），那么你一定不会喜欢我的博文。请不要骂我，并轻轻地把我划走……
...
* **23/12/…**：预计添加自定义表情包，参考教程同样是[天堂错误文件的另一篇装修博文](https://naturaleki.one/post/loadinghugo%E8%A3%85%E4%BF%AE%E6%97%A5%E5%BF%9702/)
